...
from pygame_gui_sdl2.core.interfaces import IUIElementInterface, IUIContainerInterface
from pygame_gui_sdl2.core.interfaces.window_stack_interface import IUIWindowStackInterface
from pygame_gui_sdl2.core.interfaces.tool_tip_interface import IUITooltipInterface
...
from pygame_gui_sdl2.core.resource_loaders import IResourceLoader, BlockingThreadedResourceLoader
from pygame_gui_sdl2.core.utility import PackageResource, get_default_manager, set_default_manager
from pygame_gui_sdl2.core.layered_gui_group import LayeredGUIGroup
from pygame_gui_sdl2.core import ObjectID
...
class UIManager(IUIManagerInterface):
    ...
    def __init__(self, renderer: Renderer,
        ...
        self.ui_theme = UIAppearanceTheme(self.renderer, self.resource_loader, self._locale)
        ...
        self.root_container = UIContainer(renderer, pygame.Rect((0, 0), self.window_resolution),
    ...
    def get_shadow(self, size: Tuple[int, int], shadow_width: int = 2,
                   shape: str = 'rectangle', corner_radius: int = 2) -> TextureLayer:
        """
    ...
    def get_universal_empty_texture(self) -> TextureLayer:
        """
        ...
        """
        return self.universal_empty_texture.copy()
    ...
    def create_tool_tip(self,
        ...
        """
        tool_tip = UITooltip(self.renderer, text, hover_distance, self, text_kwargs=text_kwargs,
    ...
    def set_mouse_pos_scale_factor(self, mouse_pos_scale_factor: float):
        self.mouse_pos_scale_factor = mouse_pos_scale_factor

    def set_mouse_pos_scale_factor_x(self, mouse_pos_scale_factor_x: float):
        self.mouse_pos_scale_factor[0] = mouse_pos_scale_factor_x

    def set_mouse_pos_scale_factor_y(self, mouse_pos_scale_factor_y: float):
        self.mouse_pos_scale_factor[1] = mouse_pos_scale_factor_y
        
    def get_mouse_pos_scale_factor(self) -> float:
        return self.mouse_pos_scale_factor
