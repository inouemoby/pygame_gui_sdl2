...
from pygame_gui_sdl2.core.utility import FontResource
...
class UIFontDictionary(IUIFontDictionaryInterface):
    ...
    def _load_single_font_style(self,
        ...
        """
        resource = FontResource(self.renderer, font_id=font_id,
                                size=font_size,
                                style=font_style,
                                location=font_loc)
