...
from pygame_gui_sdl2.core.utility import ClosableQueue, StoppableOutputWorker
from pygame_gui_sdl2.core.utility import ImageResource, FontResource, SurfaceResource, TextureResource
...
class IResourceLoader(metaclass=ABCMeta):
    ...
    @abstractmethod
    def add_resource(self, resource: Union[FontResource, ImageResource, SurfaceResource, TextureResource]):
        """
