...
from pygame_gui_sdl2.core.interfaces import IUIAppearanceThemeInterface
...
from pygame_gui_sdl2.core.text.text_layout_rect import TextFloatPosition, Padding
...
class HTMLParser(html.parser.HTMLParser):
    ...
    def create_styled_text_chunk(self, text: str):
        ...
        if self.current_style['link']:
            ...
            chunk = TextLineChunkFTFont(self.renderer,
                                        text,
                                        chunk_font,
