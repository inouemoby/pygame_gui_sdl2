...
from pygame_gui_sdl2._constants import UI_TEXT_EFFECT_FINISHED, TEXT_EFFECT_TYPING_APPEAR
from pygame_gui_sdl2.core.interfaces.text_owner_interface import IUITextOwnerInterface
...
class TypingAppearEffect(TextEffect):
    ...
    def __init__(self, text_owner: IUITextOwnerInterface,
        ...
        self.text_owner.clear_text_texture(self.text_sub_chunk)
