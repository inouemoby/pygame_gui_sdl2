...
class TextLineChunkFTFont(TextLayoutRect):
    ...
    def __init__(self, renderer: Renderer,
        ...
        super().__init__(renderer, (text_width, text_height), can_split=True)
        ...
        self.target_texture: Optional[TextureLayer] = None
        self.target_texture_area = None
        ...
        self.alpha = 255
        self.pre_effect_target_texture = None
    ...
    def finalise(self,
        ...
        target_texture = self._finalise_horizontal_scroll(target_area,
                                                          text_shadow_width,
                                                          x_scroll_offset,
                                                          target_texture,
                                                          texture)
        ...
        self.target_texture_area = target_area
    ...
    def split(self,
        ...
        if split_text_ok:
            ...
            return self._split_at(right_side, self.topright, self.target_texture,
                                  self.target_texture_area, self.should_centre_from_baseline)
        else:
            return None
    ...
    def split_index(self, index):
        ...
        if 0 <= index < len(self.text):
            ...
            # special case
            return self._split_at("", self.topright, self.target_texture,
                                  self.target_texture_area, self.should_centre_from_baseline)
        else:
    ...
    def redraw(self):
        ...
        if self.target_texture is not None:
            if self.pre_effect_target_texture is not None:
                ...
                self.clear()
            self.finalise(self.target_texture,
                          self.target_texture_area,
            ...
            if self.pre_effect_target_texture is not None:
                ...
                self.pre_effect_target_texture = self.target_texture.copy()
    ...
    def grab_pre_effect_texture(self):
        """
