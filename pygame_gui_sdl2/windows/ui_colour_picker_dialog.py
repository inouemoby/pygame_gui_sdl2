...
from pygame_gui_sdl2._constants import UI_BUTTON_PRESSED, UI_HORIZONTAL_SLIDER_MOVED
from pygame_gui_sdl2._constants import UI_COLOUR_PICKER_COLOUR_PICKED, UI_TEXT_ENTRY_FINISHED
from pygame_gui_sdl2._constants import UI_COLOUR_PICKER_COLOUR_CHANNEL_CHANGED, OldType

from pygame_gui_sdl2.core.interfaces import IUIManagerInterface, IContainerLikeInterface
from pygame_gui_sdl2.core import UIElement, UIContainer, ObjectID

from pygame_gui_sdl2.elements import UIWindow, UIButton, UIImage
from pygame_gui_sdl2.elements import UIHorizontalSlider, UILabel, UITextEntryLine
...
class UIColourChannelEditor(UIElement):
    ...
    def __init__(self, renderer,
        ...
        self._set_image(self.ui_manager.get_universal_empty_texture())
...
class UIColourPickerDialog(UIWindow):
    ...
    def __init__(self, rect: pygame.Rect,
        ...
        current_colour_texture = TextureLayer(self.renderer, size=(64, 64))
        current_colour_texture.fill(self.current_colour)

        self.current_colour_image = UIImage(pygame.Rect(default_sizes['element_spacing'],
                                                        -100,
                                                        64,
                                                        64),
                                            image_texture=current_colour_texture,
                                            manager=self.ui_manager,
                                            container=self,
                                            anchors={'left': 'left',
                                                     'right': 'left',
        ...
        mini_colour_texture = TextureLayer(self.renderer, size=(2, 2))
        mini_colour_texture.fill(pygame.Color(0, 0, 0, 255), pygame.Rect(0, 0, 1, 2))
        mini_colour_texture.fill(pygame.Color(255, 255, 255, 255), pygame.Rect(1, 1, 1, 1))

        hue_colour = pygame.Color(255, 255, 255, 255)
        hue_colour.hsva = (int(self.current_colour.hsva[0]),
                           100, 100, 100)
        mini_colour_texture.fill(hue_colour, pygame.Rect(1, 0, 1, 1))
        self.sat_value_square = UIImage(pygame.Rect(default_sizes['element_spacing'],
                                                    default_sizes['element_spacing'],
                                                    200,
                                                    200),
                                        image_texture=mini_colour_texture.copy().scale_to((200, 200)),
                                        manager=self.ui_manager,
                                        container=self)
    ...
    def update_current_colour_image(self):
        ...
        current_colour_texture = TextureLayer(self.renderer, size=(64, 64))
        current_colour_texture.fill(self.current_colour)
        self.current_colour_image._set_image(current_colour_texture)
    ...
    def update_saturation_value_square(self):
        ...
        hue_colour.hsva = (int(self.hue_channel.current_value),
                           100, 100, 100)
        mini_colour_texture.fill(hue_colour, pygame.Rect(1, 0, 1, 1))
        self.sat_value_square._set_image(mini_colour_texture.copy().scale_to((200, 200)))
