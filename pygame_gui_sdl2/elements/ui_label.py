...
from pygame_gui_sdl2._constants import UITextEffectType, TEXT_EFFECT_TYPING_APPEAR
from pygame_gui_sdl2._constants import TEXT_EFFECT_FADE_IN, TEXT_EFFECT_FADE_OUT
from pygame_gui_sdl2.core.text.text_effects import TypingAppearEffect, FadeInEffect, FadeOutEffect
from pygame_gui_sdl2.core.text import TextLineChunkFTFont
...
class UILabel(UIElement, IUITextOwnerInterface):
    ...
    def __init__(self, renderer, relative_rect: pygame.Rect,
                 text: str,
    ...
    def clear_text_texture(self, sub_chunk: Optional[TextLineChunkFTFont] = None):
        self.drawable_shape.text_box_layout.clear_final_texture()
