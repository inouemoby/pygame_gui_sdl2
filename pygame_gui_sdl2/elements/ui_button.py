...
from pygame_gui_sdl2.core.utility import translate
from pygame_gui_sdl2._constants import UI_BUTTON_ON_HOVERED, UI_BUTTON_ON_UNHOVERED, OldType
...
from pygame_gui_sdl2.core.drawable_shapes import EllipseDrawableShape, RoundedRectangleShape
from pygame_gui_sdl2.core.drawable_shapes import RectDrawableShape
...
class UIButton(UIElement):
    ...
    def __init__(self, renderer, relative_rect: Union[pygame.Rect, Tuple[float, float], pygame.Vector2],
                 text: str,
        ...
        super().__init__(renderer, rel_rect,
                         manager, container,
    ...
    def rebuild(self):
        ...
        if self.shape == 'rectangle':
            self.drawable_shape = RectDrawableShape(self.renderer, drawable_shape_rect, theming_parameters,
                                                    ['normal', 'hovered', 'disabled',
                                                     'selected', 'active'], self.ui_manager)
        elif self.shape == 'ellipse':
            self.drawable_shape = EllipseDrawableShape(self.renderer, drawable_shape_rect, theming_parameters,
                                                       ['normal', 'hovered', 'disabled',
                                                        'selected', 'active'], self.ui_manager)
        elif self.shape == 'rounded_rectangle':
            self.drawable_shape = RoundedRectangleShape(self.renderer, drawable_shape_rect, theming_parameters,
                                                        ['normal', 'hovered', 'disabled',
                                                         'selected', 'active'], self.ui_manager)
