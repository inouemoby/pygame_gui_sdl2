...
from pygame_gui_sdl2.core.utility import clipboard_paste, clipboard_copy
...
from pygame_gui_sdl2._constants import UI_TEXT_ENTRY_CHANGED
...
class UITextEntryBox(UITextBox):
    ...
    def __init__(self, renderer,
        ...
        super().__init__(renderer, initial_text,
                         relative_rect,
                         manager=manager,
                         container=container,
