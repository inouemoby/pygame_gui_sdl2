...
from pygame_gui_sdl2.core.interfaces import IUIManagerInterface, IUITooltipInterface, IUIElementInterface
...
class UITooltip(UIElement, IUITooltipInterface):
    ...
    def __init__(self, renderer,
        ...
        super().__init__(renderer, relative_rect=pygame.Rect((0, 0), (-1, -1)),
                         manager=manager,
                         container=None,
        ...
        self.text_block = UITextBox(self.renderer,
                                    html_text,
