...
from pygame_gui_sdl2._constants import UI_HORIZONTAL_SLIDER_MOVED, UI_BUTTON_PRESSED, OldType
...
class UIHorizontalSlider(UIElement):
    ...
    def __init__(self, renderer,
        ...
        self.sliding_button = UIButton(self.renderer,
                                       pygame.Rect((sliding_x_pos, 0),
    ...
    def rebuild(self):
        ...
        if self.shape == 'rectangle':
            self.drawable_shape = RectDrawableShape(self.renderer,
        ...
        if self.button_container is None:
            self.button_container = UIContainer(self.renderer,
        ...
        if self.enable_arrow_buttons:
            ...
            if self.left_button is None:
                self.left_button = UIButton(self.renderer,pygame.Rect((0, 0),
            ...
            if self.right_button is None:
                self.right_button = UIButton(self.renderer,pygame.Rect((-self.arrow_button_width, 0),
                                                         (self.arrow_button_width,
                                                          self.background_rect.height)),
                                             '▶', self.ui_manager,
                                             container=self.button_container,
