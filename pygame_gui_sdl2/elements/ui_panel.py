...
class UIPanel(UIElement, IContainerLikeInterface):
    ...
    :param visible: Whether the element is visible by default. Warning - container visibility
                    may override this.
    """
    default_scale_type = "scale_short"
    ...
    def __init__(self, renderer,
                 ...
                 *,
                 ...
                 visible: int = 1,
                 background_image: TextureLayer = None,
                 ):
        ...
        self.panel_container = UIContainer(self.renderer, container_rect, manager,
                                           starting_height=starting_height,
                                           container=container,
                                           parent_element=self,
    ...
    def set_background_image(self,
                            new_background_image: Union[TextureLayer, None],
                            scale_type: str = '') -> None:
        """
        ...
        if new_background_image is not None:
            image_texture = new_background_image.convert_alpha()
            if scale_type not in UIPanel.scale_type_list:
                scale_type = UIPanel.default_scale_type

            self.background_image = image_texture
