...
from pygame_gui_sdl2._constants import UI_WINDOW_CLOSE, UI_WINDOW_MOVED_TO_FRONT, UI_BUTTON_PRESSED
from pygame_gui_sdl2._constants import OldType

from pygame_gui_sdl2.core import ObjectID
from pygame_gui_sdl2.core.interfaces import IContainerLikeInterface, IUIContainerInterface
from pygame_gui_sdl2.core.interfaces import IWindowInterface, IUIManagerInterface
from pygame_gui_sdl2.core import UIElement, UIContainer
...
class UIWindow(UIElement, IContainerLikeInterface, IWindowInterface):
    ...
    def __init__(self, renderer,
        ...
        super().__init__(renderer, rect, manager, container=None,
    ...
    def rebuild(self):
        ...
        if self._window_root_container is None:
            self._window_root_container = UIContainer(self.renderer,
                                                      pygame.Rect(self.relative_rect.x +
                                                                  self.shadow_width,
        ...
        if self.window_element_container is None:
            ...
            self.window_element_container = UIContainer(self.renderer,
            ...
            if self.enable_title_bar:
                if self.title_bar is not None:
                    ...
                    title_bar_width = (self._window_root_container.relative_rect.width -
                                       self.title_bar_close_button_width)
                    self.title_bar = UIButton(self.renderer,
                ...
                if self.enable_close_button:
                    if self.close_window_button is not None:
                        ...
                        close_rect = pygame.Rect((-self.title_bar_close_button_width, 0),
                                                 (self.title_bar_close_button_width,
                                                  self.title_bar_height))
                        self.close_window_button = UIButton(self.renderer,
