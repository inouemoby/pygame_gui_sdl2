...
from pygame_gui_sdl2._constants import UI_BUTTON_PRESSED, UI_SELECTION_LIST_NEW_SELECTION
from pygame_gui_sdl2._constants import UI_DROP_DOWN_MENU_CHANGED, OldType

from pygame_gui_sdl2.core.interfaces import IContainerLikeInterface, IUIManagerInterface
from pygame_gui_sdl2.core import UIElement, ObjectID
...
from pygame_gui_sdl2.elements.ui_button import UIButton
from pygame_gui_sdl2.elements.ui_selection_list import UISelectionList
...
class UIExpandedDropDownState:
    ...
    def rebuild(self):
        ...
        if self.drop_down_menu_ui.shape == 'rectangle':
            self.drop_down_menu_ui.drawable_shape = RectDrawableShape(self.renderer,shape_rect,
                                                                      theming_parameters,
                                                                      ['normal'],
                                                                      self.ui_manager)

        elif self.drop_down_menu_ui.shape == 'rounded_rectangle':
            self.drop_down_menu_ui.drawable_shape = RoundedRectangleShape(self.renderer,shape_rect,
                                                                          theming_parameters,
                                                                          ['normal'],
                                                                          self.ui_manager)
    ...
    def start(self, should_rebuild: bool = True):
        ...
        self.active_buttons = []
        self.selected_option_button = UIButton(self.renderer,
                                               pygame.Rect((border_and_shadow, border_and_shadow),
        ...
        if self.close_button_width > 0:
            ...
            self.close_button = UIButton(self.renderer,
                                         pygame.Rect((close_button_x,
                                                      border_and_shadow),
                                                     (self.close_button_width,
                                                      self.base_position_rect.height)),
                                         expand_button_symbol,
        ...
        self.options_selection_list = UISelectionList(self.renderer,
                                                      list_rect,
                                                      starting_height=3,
...
class UIClosedDropDownState:
    ...
    def rebuild(self):
        ...
        if self.drop_down_menu_ui.shape == 'rectangle':
            self.drop_down_menu_ui.drawable_shape = RectDrawableShape(self.renderer,
            ...
            self.drop_down_menu_ui.drawable_shape = RoundedRectangleShape(self.renderer,
                                                                          shape_rect,
                                                                          theming_parameters,
                                                                          ['normal', 'disabled'],
                                                                          self.ui_manager)

        self.drop_down_menu_ui._set_image(self.drop_down_menu_ui.drawable_shape.get_fresh_texture())
        ...
        if self.open_button_width > 0:
            ...
            if self.expand_direction is not None:
                if self.expand_direction == 'up':
                    ...
                    expand_button_symbol = '▼'
            self.open_button = UIButton(self.renderer,
                                        pygame.Rect((open_button_x,
                                                     border_and_shadow),
                                                    (self.open_button_width,
                                                     self.base_position_rect.height)),
                                        expand_button_symbol,
    ...
    def process_event(self, event: pygame.event.Event) -> bool:
        ...
        if event.type == UI_BUTTON_PRESSED:
            if ((self.expand_on_option_click and event.ui_element in self.active_buttons) or
                ...
                self.should_transition = True
                return True
            # print("drop_down button pressed")
...
class UIDropDownMenu(UIContainer):
    ...
    def __init__(self,
        ...
        super().__init__(renderer, relative_rect, manager, container=container,
                         starting_height=0,
                         anchors=anchors,
                         visible=visible,
                         object_id=object_id,
        ...
        self.menu_states = {'closed': UIClosedDropDownState(self.renderer,
                                                            self,
                                                            self.selected_option,
                            ...
                            'expanded': UIExpandedDropDownState(self.renderer,
                                                                self,
                                                                self.options_list,
                                                                self.selected_option,
                                                                self.background_rect,
    ...
    def on_fresh_drawable_shape_ready(self):
        ...
        """
        self._set_image(self.drawable_shape.get_fresh_texture())
