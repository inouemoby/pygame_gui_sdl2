...
from pygame_gui_sdl2._constants import UI_TEXT_BOX_LINK_CLICKED, OldType, UITextEffectType
from pygame_gui_sdl2._constants import TEXT_EFFECT_TYPING_APPEAR, TEXT_EFFECT_TILT
from pygame_gui_sdl2._constants import TEXT_EFFECT_FADE_IN, TEXT_EFFECT_FADE_OUT, TEXT_EFFECT_BOUNCE
from pygame_gui_sdl2._constants import TEXT_EFFECT_EXPAND_CONTRACT, TEXT_EFFECT_SHAKE
...
from pygame_gui_sdl2.core.text.text_box_layout import TextBoxLayout
...
class UITextBox(UIElement, IUITextOwnerInterface):
            ...
            if self.dynamic_height or self.dynamic_width:
                ...
                scroll_bar_rect = pygame.Rect(scroll_bar_position,
                                              (self.scroll_bar_width,
                                               ...
                                               (2 * self.border_width) -
                                               (2 * self.shadow_width)))
                self.scroll_bar = UIVerticalScrollBar(self.renderer,
                                                      scroll_bar_rect,
                                                      percentage_visible,
                                                      self.ui_manager,
                                                      self.ui_container,
    ...
    def parse_html_into_style_data(self):
        ...
        self.text_box_layout = TextBoxLayout(self.renderer,self.parser.layout_rect_queue,
    ...
    def _reparse_and_rebuild(self):
        self.parser = HTMLParser(self.renderer, self.ui_theme, self.combined_element_ids,
    ...
    def clear_text_texture(self,
                           sub_chunk: Optional[TextLineChunkFTFont] = None):
        if sub_chunk is None:
            self.text_box_layout.clear_final_texture()
        else:
            sub_chunk.clear()
